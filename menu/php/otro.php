            ...
            <?php
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='/mavala/menu/php/edit.php?id=$row[idProduc]'>Editar</a>
                                <a class='btn btn-danger btn-sm' href='/mavala/menu/php/delete.php?id=$row[idProduc]'>Eliminar</a>
                            </td>
                        </tr>
                        ";
                    }
